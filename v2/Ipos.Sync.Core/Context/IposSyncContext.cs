...
using Ipos.Sync.Core.Models.Map;
using System;
...
namespace Ipos.Sync.Core.Context
{
    public class IposSyncContext : DbContext, IContext
    {
        ...
        static IposSyncContext()
        {
            Database.SetInitializer<IposSyncContext>(null);
        }
        public IposSyncContext()
            : base("name=IposSyncContext")
        {
            
        }
        public IposSyncContext(String connectionStringName)
        ...
        protected virtual TEntity AttachEntityToContext<TEntity>(TEntity entity) where TEntity : BaseEntity<Guid>, new()
        {
        ...
        public IList<TEntity> ExecuteStoredProcedureList<TEntity>(string commandText, params object[] parameters) where TEntity : BaseEntity<Guid>, new()
        {
