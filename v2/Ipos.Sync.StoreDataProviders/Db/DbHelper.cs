...
namespace Ipos.Sync.StoreDataProviders.Db
{
    public class DBHelper
    {
        ...
        private readonly string S_CONNECTION;
        private readonly string S_PROVIDER;

        public DBHelper(String connectionString, String providerName)
        {
            S_CONNECTION = connectionString;
            S_PROVIDER = providerName;
        ...
        public DBHelper() :
            this(ConfigurationManager.AppSettings["DATA.CONNECTIONSTRING"]
